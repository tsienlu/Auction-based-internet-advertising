 ...
 * @author prat
 */
public class ViewMarketingStrategiesJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewMarketingStrategiesJPanel(JPanel upc, PublisherEnterprise pubEnterprise) {
        initComponents();
    ...
    private void populateComboBox() {
        ...
        for (MarketingStrategy ms : enterprise.getMarketingStrategyList().getMarketingStrategyList()) {
            for (String cat : ms.getCategoryList()) {
    ...
    private void populateStrategiesTable() {
        ...
        for (MarketingStrategy ms : enterprise.getMarketingStrategyList().getMarketingStrategyList()) {
          for(String cate:ms.getCategoryList()) {
              if(cat.equalsIgnoreCase(cate)) {
                Object row[] = new Object[4];
                row[1] = ms;
                row[0] = ms.getCostPerImpression();
                row[2] = ms.getUserAge();
                row[3] = ms.getTimeOfDay();
                dtm.addRow(row);
              }
            }
        }
    ...
    private void initComponents() {
        ...
        strategyJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cost Per Impression", "User Location", "User age", "Time Of day"
            }
        ));
