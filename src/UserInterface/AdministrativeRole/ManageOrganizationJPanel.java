    ...
    private void populateCombo() {
        ...
        if (enterprise instanceof PublisherEnterprise) {
            for (Type type : Organization.Type.values()) {
                if (!type.getValue().equals(Type.Admin.getValue()) && !type.getValue().equals(Type.AdvertiserProductOrganization.getValue())
                        && !type.getValue().equals(Type.AdvertisingAgencyOrganization.getValue())) {
                    organizationJComboBox.addItem(type);
                }
            }
        } else {
            for (Type type : Organization.Type.values()) {
                if (!type.getValue().equals(Type.Admin.getValue()) && !type.getValue().equals(Type.MarketingAgencyOrganization.getValue())
                        && !type.getValue().equals(Type.Customer.getValue())
                        && !type.getValue().equals(Type.PublisherProductOrganization.getValue())) {
                    organizationJComboBox.addItem(type);
                }
