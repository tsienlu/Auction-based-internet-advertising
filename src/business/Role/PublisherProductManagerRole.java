...
import UserInterface.PublisherProductManagerRole.PublisherProductManagerWorkArea;
 ...
 * @author varsha
 */
public class PublisherProductManagerRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business, AdExchange adExchange) {
       return new PublisherProductManagerWorkArea(userProcessContainer, (PublisherEnterprise)enterprise);
    }
